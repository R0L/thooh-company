...
class WxPayMchPay extends WxPayDataBase {
    ...
    public function GetDevice_info($value) {
         return $this->values['device_info'];
    }
    public function IsDevice_infoSet($value) {
        return array_key_exists('device_info', $this->values);
    }
    ...
    public function GetPartner_trade_no($value) {
         return $this->values['partner_trade_no'];
    }
    public function IsPartner_trade_noSet($value) {
